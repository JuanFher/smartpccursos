		...
		<div class="order-2 lg:col-span-2 lg:order-1">
			...
			<section class="mb-12">
				...
				@foreach ($course->sections as $section)
					...
					@endif
					>
						<header class="border bg-gray-200 px-4 py-2 cursor-pointer" x-on:click="open = !open">
			...
			<section class="card">
				<div class="card-body">
					<div class="flex items-center">
						...
						<div class="ml-4">
							<h1 class="font-bold text-gray-700 text-lg">Prof. {{$course->teacher->name}}</h1>
					...
					<article class="flex mb-6">
						...
						<div class="ml-3">
							...
							<div class="flex items-center mb-2">
								<img class="h-8 w-8 object-cover rounded-full shadow-lg mt-2" src="{{ $course->teacher->profile_photo_url }}"  alt="{{ $course->teacher->name }}">
